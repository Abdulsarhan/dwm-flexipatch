...
static const int corner_radius           = 50;
#else
...
#if BAR_PANGO_PATCH
static const char font[]            = "Ubuntu Mono:size=16:antialias=true:autohint=true";
#else
...
static char normfgcolor[]                = "#cedce4";
static char normbgcolor[]                = "#12151c";
static char normbordercolor[]            = "#909a9f";
static char normfloatcolor[]             = "#db8fd9";

static char selfgcolor[]                 = "#cedce4";
static char selbgcolor[]                 = "#7093AA";
static char selbordercolor[]             = "#cedce4";
...
static char urgfgcolor[]                 = "#648B9C";
static char urgbgcolor[]                 = "#648B9C";
static char urgbordercolor[]             = "#648B9C";
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_s,          spawn,	               SHCMD("scrot ~/pictures/screenshots/%Y-%m-%d-%T-screenshot.png && dunstify --action=\"st | nsxiv `find ~/pictures/screenshots -type f -exec ls -t1 {} + | head -1`\" \"screnshot taken!\" \"saved to ~/pictures/screenshots\"") }, //screenshot command with notification.
	/* MEDIA KEYS */
	...
	#endif // XRDB_PATCH
	{ MODKEY,                       XK_y,          setlayout,              {.v = &layouts[9]} },
